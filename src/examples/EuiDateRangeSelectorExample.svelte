...
<!-- file: "src/examples/EuiDateRangeSelectorExample.svelte" -->
<script lang="ts">
    import Example from "../Example.svelte";
    import EuiDateRangeSelector from "../lib/EuiDateRangeSelector.svelte";
</script>
<Example title="EuiDateRangeSelector" >
    <EuiDateRangeSelector>
